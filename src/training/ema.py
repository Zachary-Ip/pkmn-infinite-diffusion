...
class EMA:
    ...
    Read more here:
    https://www.reddit.com/r/MachineLearning/comments/ucflc2/d_understanding_the_use_of_ema_in_diffusion_models/?rdt=53985
    """
    ...
    def _get_params(self):
        return zip(self.online_model.parameters(), self.ema_model.parameters())

    def _get_buffers(self):
        return zip(self.online_model.buffers(), self.ema_model.buffers())
